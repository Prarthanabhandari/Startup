      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col md:flex-row items-center justify-between gap-6">
          <div className="flex items-center space-x-2">
            <div className="relative flex items-center justify-center w-8 h-8 rounded-lg bg-blue-600/10 border border-blue-500/30">
              <Cpu className="w-4 h-4 text-blue-400" />
            </div>
            <span className="text-md font-bold tracking-wider text-white">
              VOXOR<span className="text-purple-500 font-extrabold">LAB</span>
            </span>
          </div>
          ...
          <div className="flex items-center space-x-6 text-slate-500 text-xs">
            ...
            <span className="flex items-center">
              Made with <Heart className="w-3 h-3 text-rose-500 mx-1 fill-rose-500" /> by VOXOR LAB
            </span>
          </div>

          {/* Social links (SVGs to bypass module export issues) */}
          <div className="flex space-x-4">
            ...
            {/* Linkedin */}
            <a href="#" className="text-slate-500 hover:text-white transition-colors duration-200" aria-label="LinkedIn">
              <svg className="w-4 h-4 fill-current" viewBox="0 0 24 24">
